...
$cargoImagens = [
    19 => ['nome' => 'CEO', 'imagem' => 'https://i.imgur.com/7CZ2JuG.png'],
    17 => ['nome' => 'Gerente', 'imagem' => 'https://i.imgur.com/nfB6xlh.png'],
    16 => ['nome' => 'Administrador', 'imagem' => 'https://i.imgur.com/IZVmG4v.png'],
    15 => ['nome' => 'Moderador', 'imagem' => 'https://i.imgur.com/jtXamrc.png'],
];

define('TEMPO_ONLINE_EM_SEGUNDOS', 600); // 10 minutos para considerar "online" pela última atividade
...
// Função para formatar o tempo na equipe em anos, meses, semanas, dias e horas
function tempoNaEquipe($timestampEntrada) {
    ...
    if ($diferenca < 3600) { // menos de 1 hora
...
<div class="container mt-4">
    ...
    <h2 class="equipes-titulo">Equipe Staff</h2>

    <div class="tabs-wrapper">
        <div class="tabs">
            <button class="tab-btn active" data-tab="staff">Staff</button>
            <a href="/colaboradores" class="tab-btn">Colaboradores</a>
            <a href="/radio" class="tab-btn">Rádio Binc</a>
        </div>

        <div class="tab-content" id="tab-staff" style="display: block;">
            <?php
            if(empty($ranksComUsuarios)) {
                echo '<p>Nenhum membro encontrado na equipe.</p>';
            } else {
...
document.addEventListener('DOMContentLoaded', () => {
    // Tab switching for Staff only (Colaboradores e Rádio são links)
    document.querySelectorAll('.tab-btn').forEach(btn => {
        btn.addEventListener('click', e => {
            if (btn.dataset.tab === 'staff') {
                ...
                document.getElementById('tab-staff').style.display = 'block';
            }
        });
    });
});
