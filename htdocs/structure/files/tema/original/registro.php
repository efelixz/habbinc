...
<!-- Linha com 'Registro' à esquerda e anúncios no centro -->
<div class="container mt-3">
  <div class="row align-items-center">

    <!-- Texto 'Registro' à esquerda -->
    <div class="col-md-4">
    </div>

    <!-- Anúncios rotativos centralizados -->
    <div class="col-md-4 text-center">
      <div id="anuncios-rotativos" class="alert alert-info d-inline-block font-weight-bold" style="font-size: 14px; min-width: 250px; padding: 8px 15px; margin:0;">
        <!-- Mensagem via JS -->
      </div>
    </div>
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        <form method="post" id="" class="ng-pristine ng-valid">
                            ...
                            <!-- SELETOR DE GÊNERO COM IMAGENS -->
                            <div class="form-group">
                                <label>Escolha seu Gênero:</label>
                                <div class="gender-select">
                                    <label id="option_male" class="gender-option" onclick="selectGender('male')">
                                        <input type="radio" name="gener" id="gender_male" value="male" required>
                                        <img src="https://i.imgur.com/mRys0n9.png" alt="Menino">
                                        <div>Menino</div>
                                    </label>
                                    <label id="option_female" class="gender-option" onclick="selectGender('female')">
                                        <input type="radio" name="gener" id="gender_female" value="female" required>
                                        <img src="https://i.imgur.com/AD9Fs21.png" alt="Menina">
                                        <div>Menina</div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <button type="submit" name="registrar" class="btn btn-dark g-recaptcha">
                                    Criar meu avatar
                                </button>
                                <a href="<?php echo url ?>/index" class="btn btn-link" style="font-weight: bold;">
                                    Já tem conta? Entrar
                                </a>
                            </div>
                        </form>
...
function selectGender(gender) {
    ...
    document.getElementById('option_' + gender).classList.add('selected');
}

const anuncios = [
    "Poste seus status, fotos e vídeos na página inicial do Hotel.",
    "Customize seu visual e seu quarto com moedas ilimitadas!",
    "Cadastre-se agora e ganhe milhares de moedas grátis.",
    "Participe dos eventos diários e divirta-se sempre.",
    "Tudo gratuito — aproveite sem pagar nada!",
    "Ganhe moedas automaticamente ficando online.",
    "Estamos recrutando! Confira as vagas na equipe.",
];
const elemAnuncios = document.getElementById('anuncios-rotativos');
let idx = 0;

function trocarAnuncio() {
    elemAnuncios.style.opacity = 0;
    setTimeout(() => {
        elemAnuncios.textContent = anuncios[idx];
        elemAnuncios.style.opacity = 1;
