...
$config['site.nome'] = "Habbinc"; // Nome do Hotel
...
$config['registro.creditos'] = "10000"; // Créditos iniciais
...
$config['registro.contasporip'] = 5; // Quantidade de contas por IP
...
$config['tema.topheader'] = "https://i.imgur.com/bkNL1Wp.png";
