...
<body>
    ...
    if (rank == 10)
        $salsarank = "Guardiões";
    if (rank == 11)
        $salsarank = "Coordenadores";
    if (rank == 12)
        $salsarank = "Administradores";
    if (rank == 13)
        $salsarank = "Diretores";
    if (rank == 14)
        $salsarank = "CEO";
    if (rank == 15)
        $salsarank = "Moderadores";
    if (rank == 16)
        $salsarank = "Administradores";
    if (rank == 17)
        $salsarank = "Gerentes";
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <div class="app-header header-shadow">
                    ...
                    <div class="widget-content p-0">
                        <div class="widget-content-wrapper">
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="https://habbo.city/habbo-imaging/avatarimage?figure=<?php echo visual ?>&size=m&headonly=1&head_direction=2&gesture=sml"  style="width: 50px;" alt="">
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle" src="./salsa_panel_files/1.jpg" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
        ...
        <div class="theme-settings__inner">
            ...
            <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 624px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 333px;"></div></div></div>
        </div>
...
<div class="d-flex justify-content-end mb-2">
    <button class="btn btn-outline-danger btn-sm" onclick="document.querySelector('.scrollbar-sidebar').classList.toggle('d-none')">
        <i class="lnr-cross-circle"></i> Fechar Menu
    </button>
</div>

<!-- Painel -->
<div class="tabs-animation">
    <div class="mb-3 card shadow-sm animate__animated animate__fadeIn">
        ...
        <div class="no-gutters row p-3">
            <!-- Usuários Registrados -->
            <div class="col-md-3 mb-3">
                <div class="card no-shadow bg-light border-0 widget-chart text-left animate__animated animate__fadeInUp">
                    <div class="icon-wrapper rounded-circle">
                        <div class="icon-wrapper-bg opacity-10 bg-warning"></div>
                        <i class="lnr-users text-dark opacity-8"></i>
                    </div>
                    <div class="widget-chart-content">
                        <div class="widget-subheading">Registrados</div>
                        <div class="widget-numbers h4"><?php SalsaDado::usuarios_registrados($conn) ?></div>
                    </div>
                </div>
            </div>
            ...
            <!-- Itens -->
            <div class="col-md-3 mb-3">
                <div class="card no-shadow bg-light border-0 widget-chart text-left animate__animated animate__fadeInUp animate__delay-1s">
                    <div class="icon-wrapper rounded-circle">
                        <div class="icon-wrapper-bg opacity-9 bg-danger"></div>
                        <i class="lnr-graduation-hat text-white"></i>
                    </div>
                    <div class="widget-chart-content">
                        <div class="widget-subheading">Itens</div>
                        <div class="widget-numbers h4"><?php SalsaDado::items($conn) ?></div>
                    </div>
                </div>
            </div>
            ...
            <!-- Conversas -->
            <div class="col-md-3 mb-3">
                <div class="card no-shadow bg-light border-0 widget-chart text-left animate__animated animate__fadeInUp animate__delay-2s">
                    <div class="icon-wrapper rounded-circle">
                        <div class="icon-wrapper-bg opacity-9 bg-success"></div>
                        <i class="lnr-apartment text-white"></i>
                    </div>
                    <div class="widget-chart-content">
                        <div class="widget-subheading">Conversas</div>
                        <div class="widget-numbers text-success h4"><?php SalsaDado::conversas($conn) ?></div>
                    </div>
                </div>
            </div>
            ...
            <!-- Online -->
            <div class="col-md-3 mb-3">
                <div class="card no-shadow bg-light border-0 widget-chart text-left animate__animated animate__fadeInUp animate__delay-3s">
                    <div class="icon-wrapper rounded-circle">
                        <div class="icon-wrapper-bg opacity-9 bg-info"></div>
                        <i class="lnr-globe text-white"></i>
                    </div>
                    <div class="widget-chart-content">
                        <div class="widget-subheading">Online</div>
                        <div class="widget-numbers text-info h4">
        ...
        <div class="text-center p-3 card-footer">
            <small class="text-muted">Atualizado: <?php echo date("d/m/Y H:i"); ?></small>
        </div>
    </div>
</div>
...
new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['Usuários', 'Itens', 'Conversas', 'Online'],
        datasets: [{
            label: 'Total',
            data: [
                <?php echo SalsaDado::usuarios_registrados($conn) ?>,
                <?php echo SalsaDado::items($conn) ?>,
                <?php echo SalsaDado::conversas($conn) ?>,
                <?php echo SalsaDado::usuarios_online($conn) ?>
            ],
            backgroundColor: ['#f7b924', '#d92550', '#3ac47d', '#16aaff'],
            borderRadius: 8
        }]
    },
    options: {
    ...
    <div class="drawer-content-wrapper">
        <div class="scrollbar-container ps ps--active-y">
            ...
            <div class="drawer-section">
                <div class="row">
                    <div class="col">
                        <div class="progress-box"><h4>Server Load 1</h4>
                            <div class="circle-progress circle-progress-gradient-xl mx-auto"><canvas width="114" height="114"></canvas>
                    ...
                    <div class="col">
                        <div class="progress-box"><h4>Server Load 2</h4>
                            <div class="circle-progress circle-progress-success-xl mx-auto"><canvas width="114" height="114"></canvas>
                    ...
                    <div class="col">
                        <div class="progress-box"><h4>Server Load 3</h4>
                            <div class="circle-progress circle-progress-danger-xl mx-auto"><canvas width="114" height="114"></canvas>
                                <small><span class="fsize-2">51%<span></span></span></small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-3" style="position: relative;"><h5 class="text-center card-title">Live Statistics</h5>
                    <div id="sparkline-carousel-3" style="min-height: 120px;"><div id="apexchartst62hum0b" class="apexcharts-canvas apexchartst62hum0b" style="width: 402px; height: 120px;"><svg id="SvgjsSvg1456" width="402" height="120" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" class="apexcharts-svg" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;"><g id="SvgjsG1458" class="apexcharts-inner apexcharts-graphical" transform="translate(0, 0)"><defs id="SvgjsDefs1457"><clippath id="gridRectMaskt62hum0b"><rect id="SvgjsRect1461" width="405" height="123" x="-1.5" y="-1.5" rx="0" ry="0" fill="#ffffff" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0"></rect></clippath><clippath id="gridRectMarkerMaskt62hum0b"><rect id="SvgjsRect1462" width="410" height="128" x="-4" y="-4" rx="0" ry="0" fill="#ffffff" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0"></rect></clippath></defs><rect id="SvgjsRect1460" width="0" height="120" x="0" y="0" rx="0" ry="0" fill="#b1b9c4" opacity="1" stroke-width="0" stroke-dasharray="0" class="apexcharts-xcrosshairs" filter="none" fill-opacity="0.9"></rect><g id="SvgjsG1469" class="apexcharts-xaxis" transform="translate(0, 0)"><g id="SvgjsG1470" class="apexcharts-xaxis-texts-g" transform="translate(0, -4)"></g></g><g id="SvgjsG1473" class="apexcharts-grid"><line id="SvgjsLine1475" x1="0" y1="120" x2="402" y2="120" stroke="transparent" stroke-dasharray="0"></line><line id="SvgjsLine1474" x1="0" y1="1" x2="0" y2="120" stroke="transparent" stroke-dasharray="0"></line></g><g id="SvgjsG1464" class="apexcharts-line-series apexcharts-plot-series"><g id="SvgjsG1465" class="apexcharts-series series-1" data:longestSeries="true" rel="1" data:realIndex="0"><path id="apexcharts-line-0" d="M 8.375 57.10174717368962C 14.2375 57.10174717368962 19.2625 5.3031860226104754 25.125 5.3031860226104754C 30.9875 5.3031860226104754 36.0125 66.96813977389516 41.875 66.96813977389516C 47.7375 66.96813977389516 52.7625 76.83453237410072 58.625 76.83453237410072C 64.4875 76.83453237410072 69.5125 81.76772867420348 75.375 81.76772867420348C 81.2375 81.76772867420348 86.2625 86.70092497430628 92.125 86.70092497430628C 97.9875 86.70092497430628 103.0125 63.26824254881809 108.875 63.26824254881809C 114.7375 63.26824254881809 119.7625 53.401849948612536 125.625 53.401849948612536C 131.4875 53.401849948612536 136.5125 90.40082219938336 142.375 90.40082219938336C 148.2375 90.40082219938336 153.2625 74.36793422404932 159.125 74.36793422404932C 164.9875 74.36793422404932 170.0125 50.935251798561154 175.875 50.935251798561154C 181.7375 50.935251798561154 186.7625 76.83453237410072 192.625 76.83453237410072C 198.4875 76.83453237410072 203.5125 86.70092497430628 209.375 86.70092497430628C 215.2375 86.70092497430628 220.2625 71.90133607399794 226.125 71.90133607399794C 231.9875 71.90133607399794 237.0125 39.8355601233299 242.875 39.8355601233299C 248.7375 39.8355601233299 253.7625 62.03494347379239 259.625 62.03494347379239C 265.4875 62.03494347379239 270.5125 43.53545734840698 276.375 43.53545734840698C 282.2375 43.53545734840698 287.2625 73.13463514902364 293.125 73.13463514902364C 298.9875 73.13463514902364 304.0125 53.401849948612536 309.875 53.401849948612536C 315.7375 53.401849948612536 320.7625 44.76875642343268 326.625 44.76875642343268C 332.4875 44.76875642343268 337.5125 54.635149023638235 343.375 54.635149023638235C 349.2375 54.635149023638235 354.2625 64.50154162384378 360.125 64.50154162384378C 365.9875 64.50154162384378 371.0125 96.56731757451182 376.875 96.56731757451182C 382.7375 96.56731757451182 387.7625 69.43473792394656 393.625 69.43473792394656" fill="none" fill-opacity="1" stroke="rgba(58,196,125,0.85)" stroke-opac
="SvgjsG1478" class="apexcharts-yaxis-annotations"></g><g id="SvgjsG1479" class="apexcharts-xaxis-annotations"></g><g id="SvgjsG1480" class="apexcharts-point-annotations"></g></g><g id="SvgjsG1471" class="apexcharts-yaxis" rel="0" transform="translate(-35, 0)"><g id="SvgjsG1472" class="apexcharts-yaxis-texts-g"></g></g></svg><div class="apexcharts-legend"></div></div></div>
                    <div class="row">
                        <div class="col">
                ...
                <div class="resize-triggers"><div class="expand-trigger"><div style="width: 403px; height: 287px;"></div></div><div class="contract-trigger"></div></div></div>
            </div>
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left"><img width="42" class="rounded" src="./salsa_panel_files/1.jpg" alt=""></div>
                                    </div>
                                    <div class="widget-content-left">
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            ...
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img src="./salsa_panel_files/6.jpg" alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img src="./salsa_panel_files/7.jpg" alt=""></div>
                                            </div>
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 624px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 274px;"></div></div></div>
    </div>
</div>
...
<svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;"><defs id="SvgjsDefs1002"></defs><polyline id="SvgjsPolyline1003" points="0,0"></polyline><path id="SvgjsPath1004" d="M-1 152L-1 152C-1 152 29.9375 152 29.9375 152C29.9375 152 49.89583333333333 152 49.89583333333333 152C49.89583333333333 152 69.85416666666666 152 69.85416666666666 152C69.85416666666666 152 89.81249999999999 152 89.81249999999999 152C89.81249999999999 152 109.77083333333331 152 109.77083333333331 152C109.77083333333331 152 129.72916666666666 152 129.72916666666666 152C129.72916666666666 152 149.6875 152 149.6875 152C149.6875 152 169.64583333333334 152 169.64583333333334 152C169.64583333333334 152 189.60416666666669 152 189.60416666666669 152C189.60416666666669 152 209.56250000000003 152 209.56250000000003 152C209.56250000000003 152 229.52083333333337 152 229.52083333333337 152C229.52083333333337 152 249.4791666666667 152 249.4791666666667 152C249.4791666666667 152 269.43750000000006 152 269.43750000000006 152C269.43750000000006 152 289.39583333333337 152 289.39583333333337 152C289.39583333333337 152 309.3541666666667 152 309.3541666666667 152C309.3541666666667 152 329.3125 152 329.3125 152C329.3125 152 349.2708333333333 152 349.2708333333333 152C349.2708333333333 152 369.22916666666663 152 369.22916666666663 152C369.22916666666663 152 389.18749999999994 152 389.18749999999994 152C389.18749999999994 152 409.14583333333326 152 409.14583333333326 152C409.14583333333326 152 429.1041666666666 152 429.1041666666666 152C429.1041666666666 152 449.0624999999999 152 449.0624999999999 152C449.0624999999999 152 469.0208333333332 152 469.0208333333332 152C469.0208333333332 152 469.0208333333332 152 469.0208333333332 152 "></path></svg><div class="jvectormap-tip"></div></body></html>