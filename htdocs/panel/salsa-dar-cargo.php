         ...
         <?php SalsaPainel::dar_cargo($conn) ?>
                                <form method="post">
                                    ...
                                    <select class="form-control" name="vlr2">
                                        ...
                                        <label>Função/Tarefa que irá exercer:</label><br>
<input class="form-control" type="text" name="task" placeholder="Ex: Eventos, Atendimento, Designer"><br>
                                    ...
                                    <br>
                                    <input value="Ok" class="btn btn-success" type="submit" name="fnvlr">
                                </form>
    </div>
