<?php
$sql = "SELECT * FROM cms_news WHERE id='".$noticiafinal."'";
...
<div class="col-sm-12">
    ...
    <form method="post">
        ...
        <b><label for="titulo">Título da notícia:</label></b>
        <input id="titulo" value="<?php echo htmlspecialchars($row['title'], ENT_QUOTES); ?>" class="form-control" type="text" name="vlr2" required>

        <b><label for="descricao">Descrição curta da notícia:</label></b>
        <input id="descricao" value="<?php echo htmlspecialchars($row['shortstory'], ENT_QUOTES); ?>" class="form-control" type="text" name="vlr3" required>

        <input type="hidden" name="id" value="<?php echo intval($row['id']); ?>">

        <b><label for="imagem">Imagem de capa (exemplo: http://imgur.com/anujWm.png):</label></b>
        <input id="imagem" value="<?php echo htmlspecialchars($row['image'], ENT_QUOTES); ?>" class="form-control" type="text" name="vlr4" required>

        <b><label for="news">Conteúdo da notícia:</label></b><br>
        <textarea id="news" name="news" rows="15" cols="80"><?php echo htmlspecialchars($row['longstory']); ?></textarea>

 <br>
        <input value="Publicar" class="btn btn-success" type="submit" name="fnvlr">
    </form>
    ...
    <script>
      // Ativa o CKEditor no textarea "conteudo"
      CKEDITOR.replace('conteudo', {
        height: 300,
        // Toolbar customizada para editor estilo Word, pode ser ajustada conforme necessidade
        toolbar: [
        ...
        // Permitir upload de imagens via URL (se você configurar seu backend)
        // Para upload direto é preciso backend, mas pode inserir links mesmo
        filebrowserImageBrowseUrl: '', // Se tiver algum gerenciador de arquivos
      });
    </script>
</div>
