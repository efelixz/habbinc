...
<div class="col-sm-12">
    ...
    <form method="post">
        ...
        <input id="titulo" class="form-control" type="text" name="vlr2" required>

        <b><label for="descricao">Descrição curta da notícia:</label></b>
        <input id="descricao" class="form-control" type="text" name="vlr3" required>

        <b><label for="promocao">A promoção está ativa?</label></b>
        <select id="promocao" name="vlr5" class="form-control" required>
            <option value="0" selected>Não</option>
            <option value="1">Sim</option>
        </select>

        <b><label for="imagem_capa">Imagem de capa (exemplo http://imgur.com/anujWm.png):</label></b>
        <input id="imagem_capa" class="form-control" type="url" name="vlr4" placeholder="http://..." required>

        <b><label for="conteudo">Conteúdo da notícia:</label></b>
        <textarea id="conteudo" name="news" rows="15" cols="80"></textarea>
